...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lucky-dust-26af)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-dust-26af
```

A live public deployment of this template is available at [https://lucky-dust-26af.templates.workers.dev](https://lucky-dust-26af.templates.workers.dev)
